    ...
    <div className="sheet-veil" onClick={() => setOpen(false)}>
      ...
      >
        ...
        <div style={{
          ...
          <span style={{ color: 'var(--ink)', fontWeight: 500 }}>美团生态给条件</span>：理由之外，大学生拒绝运动的一个重要原因——启动摩擦太大，美团生态可以把物理条件也备好——装备和水通过外卖提前送达，场地提前订好。到运动场不是"开始"——开始早就发生在你把球鞋塞进柜子的那一秒，发生在你下单订好场地的那一下。
        </div>
        <div style={{
          fontSize: 12.5,
          color: 'var(--ink-soft)',
